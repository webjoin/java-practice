...
public class AbstractMapperTest {
     ...
     *
     * @param tableName
     * @param domainObjectName 对应表的类名 ，可为空
     */
    protected void generateClass(String tableName, String domainObjectName) {
        // 表映射对象名称
        String mapperName = null;
        if (StringUtils.isBlank(domainObjectName)) {
            String domainName = getClassName(tableName);
...
//        System.setProperty("primaryKeyName", "id");
    }
    ...
    public void after() throws URISyntaxException {
        ...
        System.err.println("--");
        System.err.println("如果字段名包含了\"_\"请设置 System.setProperty(\"useActualColumnNames\", \"false\") 参考方法GeneratorRestaurantTest.testGenerateTRoleMenu");
        ...
        URL resource = getClass().getResource("/generatorConfig.xml");
        File file = new File(resource.toURI().getSchemeSpecificPart());
        String absolutePath = file.getAbsolutePath();
        absolutePath = "generatorConfig.xml";
//        String configFilePath;
//        File file;
//        configFilePath = cp + "/generatorConfig.xml";
//        file = new File(configFilePath);
//        if (!file.exists()) {
//            configFilePath = cp + "../../../resources/test/generatorConfig.xml";
//            file = new File(configFilePath);
//        }
//        if (!file.exists()) {
//            throw new IllegalArgumentException("文件为空：" + absolutePath);
//        }
